...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "ja_ads_attachment", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(0.65, 0.1, -1.2), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
    ...
    },
    {
        ...
        Offset = {
            vpos = Vector(1.25, -4, 19), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
            wpos = Vector(22, 2.2, -6.65),
            wang = Angle(-10, 0, 180)
        },
