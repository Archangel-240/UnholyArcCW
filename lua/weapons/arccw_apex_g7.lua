...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "ja_ads_attachment", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(0.85, 1.25, -7.8), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -80),
    ...
    },
	{
        ...
        Offset = {
            vpos = Vector(1.4, -3.4, 20), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
            wpos = Vector(22, 2.3, -7.25),
            wang = Angle(-10, 0, 180)
        },
