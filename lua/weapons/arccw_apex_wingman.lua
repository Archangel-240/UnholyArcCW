...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Offset = {
            vpos = Vector(0.45, -4.25, 1.4), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
            wpos = Vector(5, 2, -4.5),
            wang = Angle(-10, 0, 180)
        },
    ...
    },
    {
        ...
        Bone = "def_c_base", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(1.1, -2.7, 7), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
            wpos = Vector(9.5, 2.5, -4.1),
            wang = Angle(-10, 0, 180)
        },
