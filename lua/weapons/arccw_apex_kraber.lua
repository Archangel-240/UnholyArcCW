...
SWEP.WorldModel = "models/weapons/w_apex_kraber.mdl"
SWEP.MirrorVMWM = false
SWEP.WorldModelOffset = {
    pos = Vector(13, 1, 1.25),
    ang = Angle(-10, 0, 180),
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "ja_ads_attachment", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(1.6, 1.2, -9.5), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
    ...
    },
	{
        ...
        Offset = {
            vpos = Vector(1.2, -5.5, 13), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -65),
            wpos = Vector(16, 2, -8.7),
            wang = Angle(-10, 0, 205)
        },
