...
SWEP.Trivia_Desc = "Adaptable Frontier Sub-Machine Gun boasting incredibly high hipfire precision for an SMG, and is a favourite of wall-running Pilots."
...
SWEP.Attachments = {
    ...
    },
    {
        ...
        Bone = "ja_ads_attachment", -- relevant bone any attachments will be mostly referring to
        Offset = {
            vpos = Vector(0.79, 0.85, -1), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
            wpos = Vector(6.3, 1.5, -5),
            wang = Angle(-10, 0, 180)
        },
    ...
    },
	{
        ...
        Offset = {
            vpos = Vector(0.98, -3.4, 15), -- offset that the attachment will be relative to the bone
            vang = Angle(90, 0, -90),
